...
def Youtube(): webbrowser.open("https://www.youtube.com/@ONYXDevelopment", new=0, autoraise=True)
...
yt_logo = Image.open("img/youtube_logo.png")
...
btn_discord = CTkButton(master=master_tabs.tab("Settings"), command=Discord, text="Join Discord", image=CTkImage(dark_image=d_logo, light_image=d_logo, size=(31, 24)), fg_color="#313338", border_color="#7289da", text_color="#7289da", border_width=3, corner_radius=20, font=(CTkFont, 15)).place(relx=0.025, rely=0)
...
btn_youtube = CTkButton(master=master_tabs.tab("Settings"), command=Youtube, text="Youtube", image=CTkImage(dark_image=yt_logo, light_image=yt_logo, size=(35, 24)), fg_color="#ffffff", text_color="#ff0000", border_color="#ff0000", border_width=4, corner_radius=20, font=(CTkFont, 15)).place(relx=0.025, rely=0.15)
